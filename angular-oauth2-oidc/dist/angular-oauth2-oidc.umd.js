...
var AuthConfig = (function () {
    function AuthConfig() {
         ...
         * urls.
         */
        this.openUri = function (uri) { location.href = uri; };
...
var OAuthService = (function (_super) {
    __extends$1(OAuthService, _super);
    /**
     * @param {?} http
     * @param {?} storage
...
var DefaultOAuthInterceptor = (function () {
    ...
    DefaultOAuthInterceptor.prototype.intercept = function (req, next) {
        ...
        return next.handle(req).pipe(operators.catchError(function (err) { return _this.errorHandler.handleError(err); }));
    };
